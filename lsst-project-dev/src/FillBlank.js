	...
	makeQuestion() {
		...
		this.props.info.questionText.forEach(function(d,i) {
			...
			if (d !== "BLANK") {
				...
				question.push(<div key={self.props.info.questionName + 'blank'+bla} className="answer text-input"><input type="text" name={self.props.info.questionName} id={self.props.info.questionName}	/></div>)
				bla++;
			}
		})
		return question;
